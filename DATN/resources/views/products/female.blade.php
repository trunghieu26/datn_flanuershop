            ...
            <div class="container">
                <div class="row align-items-center">
                        ...
                        <div class="img-effect img-effect-solid mb-5 mb-md-0">
                                <img src="/image/20230103034525.jpg" class="img-fluid" alt="...">
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 offset-lg-1 order-md-1" style="text-align: center;">
                        ...
                        <ul class="list-iconed text-muted">
                            <li class="list-iconed-item">
                                “Tôi thiết kế trang phục, phụ nữ tạo nên thời trang”.
                            </li>
                            <li class="list-iconed-item">
                                “Phong cách chính là một cách đơn giản để nói lên những điều phức tạp”.
                                </li>
                                <li class="list-iconed-item">
